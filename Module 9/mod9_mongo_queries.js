...
/* 2. Calculate the total payments each customer has made. Display customer name and the total payment. (98 results) */
...
/* 3. Calculate the number of payments each customer has made. Display customer name and the number of payments. (98 results in total) */
db.customers.aggregate([
    {
        $unwind: "$payments"
    },
...
/* 6. What is the sales value of each product in stock? Sale value is calculated by multiplying quantity in stock by MSRP. Display the product name and the sales value in descending order based on sales value. (110 results) */
